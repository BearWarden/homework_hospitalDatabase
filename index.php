  ...
  <div class="container">
    <nav class="navbar navbar-inverse" role="navigation">
      <div class="navbar-header">
        ...
        <a href="#" class="navbar-brand scroll-top logo  animated bounceInLeft"><b>长安<i>医院</i></b></a> </div>
      <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav">
          <li class="active" id="firstLink"><a href="#home" class="scroll-link">主页</a></li>
          <li><a href="#work" class="scroll-link">简介</a></li>
          <li><a href="#plans" class="scroll-link">事务</a></li>
          <li><a href="#team" class="scroll-link">医生</a></li>
        </ul>
      </div>
        ...
        <div id="portfolio">
          ...
          <ul class="items list-unstyled clearfix animated fadeInRight showing" data-animation="fadeInRight" style="position: relative; height: 438px;">
            <li class="item branding" style="position: absolute; left: 0px; top: 0px;"> <a href="images/work/1.jpg" class="fancybox"> <img src="images/work/1.jpg" alt="">
              <div class="overlay"> <span>一流设备</span> </div>
              </a> </li>
            <li class="item photography" style="position: absolute; left: 292px; top: 0px;"> <a href="images/work/2.jpg" class="fancybox"> <img src="images/work/2.jpg" alt="">
              <div class="overlay"> <span>精心呵护</span> </div>
              </a> </li>
            <li class="item branding" style="position: absolute; left: 585px; top: 0px;"> 
            	<a href="images/work/3.jpg" class="fancybox"><img src="images/work/3.jpg" alt="">
              <div class="overlay"> <span>注重细节</span> </div>
              </a> </li>
            <li class="item photography" style="position: absolute; left: 877px; top: 0px;"> <a href="images/work/4.jpg" class="fancybox"> <img src="images/work/4.jpg" alt="">
              <div class="overlay"> <span>最强医生</span> </div>
              </a> </li>
            <li class="item photography" style="position: absolute; left: 0px; top: 219px;"> <a href="images/work/5.jpg" class="fancybox"> <img src="images/work/5.jpg" alt="">
              <div class="overlay"> <span>专业陪伴</span> </div>
              </a> </li>
            <li class="item web" style="position: absolute; left: 292px; top: 219px;"> <a href="images/work/6.jpg" class="fancybox"> <img src="images/work/6.jpg" alt="">
              <div class="overlay"> <span>手术一流 </span> </div>
              </a> </li>
            <li class="item photography" style="position: absolute; left: 585px; top: 219px;"> <a href="images/work/7.jpg" class="fancybox"> <img src="images/work/7.jpg" alt="">
              <div class="overlay"> <span>专业技术</span> </div>
              </a> </li>
            <li class="item web" style="position: absolute; left: 877px; top: 219px;"> <a href="images/work/8.jpg" class="fancybox"> <img src="images/work/8.jpg" alt="">
              <div class="overlay"> <span>精英团队</span> </div>
              </a> </li>
          </ul>
        </div>
      </div>
    ...
    <div class="row flat">
      ...
      <div class="col-lg-3 col-md-3 col-xs-12">
        <ul class="plan plan1">
          ...
          <li class="plan-action">
          	 <a href="getNum.php" class="btn btn-danger btn-lg">
          	 	挂号通道
          	 </a>
          </li>
        </ul>
      ...
      <div class="col-lg-3 col-md-3 col-xs-12">
        <ul class="plan plan2 ">
          ...
          <li class="plan-action"> 
          	<a href="buymedcine.php" class="btn btn-danger btn-lg">
          		购药通道
          	</a>
          </li>
        </ul>
      ...
      <div class="col-lg-3 col-md-3 col-xs-12">
        <ul class="plan plan3">
          ...
          <li class="plan-action"> 
          	<a href="operation.php" class="btn btn-danger btn-lg">
          		手术预约
          	</a> 
          </li>
        </ul>
      ...
      <div class="col-lg-3 col-md-3 col-xs-12">
        ...
        <ul class="plan plan4">
          ...
          <li class="plan-action"> 
          	<a href="liveinhospital.html" class="btn btn-danger btn-lg">
          		住院通道
          	</a> 
          </li>
        </ul>
...
<section id="team" class="page-section page">
  <div class="container">
    ...
    <div class="team-content">
        ...
        <div class="col-md-3 col-sm-6 col-xs-6">   
          ...
          <div class="team-member pDark"> 
            ...
            <div class="member-img"> 
              <!-- Image  --> 
              <img class="img-responsive" src="images/docters/photo-1.jpg" alt=""> </div>
            <!-- Member Details -->
            <h4>李杜秀</h4>
            <!-- Designation --> 
            <span class="pos">院长</span>
          </div>
       	</div>
          ...
          <div class="team-member pDark"> 
            ...
            <div class="member-img"> 
              <!-- Image  --> 
              <img class="img-responsive" src="images/docters/photo-2.jpg" alt=""> 
            </div>
            <!-- Member Details -->
            <h4>刘能</h4>
            <!-- Designation --> 
            <span class="pos">副院长</span>
          </div>
       	</div>
          ...
          <div class="team-member pDark"> 
            ...
            <div class="member-img"> 
              <!-- Image  --> 
              <img class="img-responsive" src="images/docters/photo-3.jpg" alt=""> </div>
            <!-- Member Details -->
            <h4>刘媛媛</h4>
            <!-- Designation --> 
            <span class="pos">副院长</span>
          ...
          <div class="team-member pDark"> 
            ...
            <div class="member-img"> 
              <!-- Image  --> 
              <img class="img-responsive" src="images/docters/photo-4.jpg" alt=""> </div>
            <!-- Member Details -->
            <h4>王大大</h4>
            <!-- Designation --> 
            <span class="pos">儿科专家</span>
          </div>
       	</div>
      ...
      <div align="center">
      	<ul class="plan plan4">
          <li class="plan-action"> 
          	<a href="docter.php" class="btn btn-danger btn-lg">
          		管理者入口
          	</a>
          </li>
        </ul>
